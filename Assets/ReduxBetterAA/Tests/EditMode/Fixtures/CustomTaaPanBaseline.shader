Shader "Hidden/ReduxBetterAA/Tests/CustomTaaPanBaseline"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        float4 SampleHistoryCatmullRom(float2 uv)
        {
            ...
            // This is the same separable Catmull-Rom kernel in 9 reads, not 16.
        ...
        TemporalEvaluation EvaluateTemporal(float2 inputUv)
        {
            ...
            // Allow the local luminance variation near rest; fade this allowance
            // out by a quarter pixel/frame so moving detail keeps responding.
