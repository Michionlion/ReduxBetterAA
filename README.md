...
controls stationary history. DLAA defaults to K. The main menu starts with K;
F10 can change it for that menu visit without changing the gameplay preset.
Foliage motion repair and
